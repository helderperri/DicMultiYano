...
$message .= "http://linguasyanomami.com/Sanoma/dic_sanoma_login/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
if(mail($newemail, 'Email Update for you Online Notes App', $message, 'From:'.'helder@socioambiental.org')){
